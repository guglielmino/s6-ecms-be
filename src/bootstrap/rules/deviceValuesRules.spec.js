...
describe('Device values rules', () => {
  ...
  context('Device Values messages', () => {
  ...
  context('Device Values messages with Type from Topic', () => {
    it('should call devicevalues handler with correct payload for current consume', () => {
      const msg = {
        Type: 'sensors_current',
        GatewayId: 'TESTGW',
        Payload: {
          value: 10,
          unit: 'A',
